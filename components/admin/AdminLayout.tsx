  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-navy-900 p-1 rounded-xl flex overflow-x-auto scrollbar-hide">
        ...
        <button onClick={() => setActiveTab('lotteries')} className={`flex-1 min-w-[70px] py-2 px-2 rounded-lg text-[10px] font-bold uppercase tracking-wide ${activeTab === 'lotteries' ? 'bg-brand-500 text-navy-950' : 'text-slate-400'}`}>Generaciones</button>
